...
public class CourseHelper {
    ...
    public JSONObject getAll() {
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "SELECT * FROM `sa_project`.`courses`";
            ...
            while(rs.next()) {                
                ...
                String desc = rs.getString("course_desc");
                String cover = rs.getString("cover_path");
                String material = rs.getString("material_path");
    ...
    // will be used by getCartCourse() from cart.html
    public JSONObject getByIdList(String data) {
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "SELECT * FROM `sa_project`.`courses` WHERE `courses`.`course_id`";
    ...
    public Course getCourseByID(String id) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `sa_project`.`courses` WHERE `course_id` = ? LIMIT 1";
    ...
    public JSONObject getByID(String id) {
        ...
        try {
            ...
            /** 紀錄真實執行的SQL指令，並印出 **/
            exexcute_sql = pres.toString();
            System.out.println("From getByID:");
            System.out.println(exexcute_sql);
    ...
    public JSONObject create(Course c) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "INSERT INTO `sa_project`.`courses`(`course_name`, `course_price`, `course_desc`, `cover_path`, `material_path`)"
                    + " VALUES(?, ?, ?, ?, ?)";
